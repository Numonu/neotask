...
export default function Task({order , title , date}) {
	...
	return (
		<>
			<button className="pattern-points border-neutral-800 border-2 border-b-4 px-4 py-6 rounded-md text-start outline-offset-8 outline-outline hover:-translate-y-[0.2rem] hover:shadow-lg group transition-[transform_shadow]"
			onClick={navToTask}>
